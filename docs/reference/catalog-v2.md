...
Kernel `openCatalogNode` copies expected shard locators by this same closed
grammar. It rejects `null` elements, extra fields, functions, duplicate
locators, and arrays longer than four before it reads an element.
