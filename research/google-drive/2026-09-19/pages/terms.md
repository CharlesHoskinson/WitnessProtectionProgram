...
Retrieved: 2026-09-19T16:29:31.402599+00:00
...
Under the Terms, "Google" means Google LLC, with offices at 1600 Amphitheatre
...
API team for information (e.g. by using the Google developers console).
...
The Terms are non-exclusive. You acknowledge that Google may develop products or
...
1. Sublicense an API for use by a third party. Consequently, you will not
   create an API Client that functions substantially the same as the APIs and
   offer it for use by third parties.
2. Perform an action with the intent of introducing to Google products and
...
4. Interfere with or disrupt the APIs or the servers or networks providing the
   APIs.
...
7. Use the APIs for any activities where the use or failure of the APIs could
   ...
   systems).
8. Use the APIs to process or store any data that is subject to the
   International Traffic in Arms Regulations maintained by the U.S. Department
   of State.
9. Remove, obscure, or alter any Google terms of service or any links to or
...
Google unless you have received prior written consent to such use from Google.
...
2. Our communications to you and our APIs may contain Google confidential
...
using Google's Brand Features, you must follow the [Google Brand Features Use
Guidelines](https://www.google.com/permissions/guidelines.html). You understand
...
notices in our [Help Center](https://www.google.com/dmca.html).
...
page](https://www.google.com/intl/en/contact/).
